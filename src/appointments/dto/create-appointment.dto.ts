...
import { IsDateString, IsEnum, IsInt, IsMongoId, IsNotEmpty, IsNumber, IsOptional, IsPositive, IsString, MaxLength, Min } from 'class-validator';
...
export class CreateAppointmentDto {
  ...
  @ApiPropertyOptional({ enum: ['scheduled','completed','canceled'], example: 'scheduled' })
